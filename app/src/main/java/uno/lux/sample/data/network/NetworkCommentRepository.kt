...
class NetworkCommentRepository(
    ...
    override suspend fun loadComments(postId: String): List<Comment> = withContext(Dispatchers.IO) {
    ...
    override suspend fun toggleLike(postId: String, comment: Comment): Comment = withContext(Dispatchers.IO) {
